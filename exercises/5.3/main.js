...
function redirectPage(element) {
  element.target.href = 'https://betrybe.com';
}
myWebpage.addEventListener("dblclick", redirectPage);

function colorMagenta(element) {
  element.target.style.color = 'magenta';
}
myWebpage.addEventListener("mouseover", colorMagenta);

function colorWhite(element) {
  element.target.style.color = 'white';
}
myWebpage.addEventListener("mouseout", colorWhite);
